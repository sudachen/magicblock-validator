// NOTE: from rpc-client/src/http_sender.rs
...
impl HttpSender {
    ...
    pub fn new_with_client<U: ToString>(
        url: U,
    ...
    pub fn default_headers() -> header::HeaderMap {
        ...
        default_headers.append(
            ...
            header::HeaderValue::from_str(
                format!("rust/{}", sleipnir_version::Version::default())
                    .as_str(),
            )
            .unwrap(),
        );
...
impl RpcSender for HttpSender {
    ...
    async fn send(
        ...
        let request_json =
            request.build_request_json(request_id, params).to_string();
        ...
        loop {
            ...
            if json["error"].is_object() {
                return match serde_json::from_value::<RpcErrorObject>(
                    json["error"].clone(),
                ) {
                    Ok(rpc_error_object) => {
